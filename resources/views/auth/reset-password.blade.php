            ...
            <form action="{{ route('password.update') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="password" name="password" id="password" placeholder="••••••••" required class="w-full pl-16 pr-14 py-5 input-premium rounded-[28px] text-[16px] font-bold text-emerald-950">
                        <button type="button" onclick="togglePassword('password', 'eye-icon-password')" class="absolute inset-y-0 right-0 pr-6 flex items-center text-emerald-950/50 hover:text-emerald-950 focus:outline-none">
                            <svg id="eye-icon-password" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-5 h-5">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="password" name="password_confirmation" id="password_confirmation" placeholder="••••••••" required class="w-full pl-16 pr-14 py-5 input-premium rounded-[28px] text-[16px] font-bold text-emerald-950">
                        <button type="button" onclick="togglePassword('password_confirmation', 'eye-icon-confirm')" class="absolute inset-y-0 right-0 pr-6 flex items-center text-emerald-950/50 hover:text-emerald-950 focus:outline-none">
                            <svg id="eye-icon-confirm" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                            </svg>
                        </button>
