...
<head>
    ...
    <title>Lupa Password - Arya Duta</title>
...
<body class="min-h-screen flex text-emerald-950 overflow-x-hidden bg-white">
    ...
    <div class="hidden lg:flex lg:w-3/5 relative overflow-hidden bg-emerald-950">
        <img src="https://images.unsplash.com/photo-1507842217343-583bb7270b66?q=80&w=2028&auto=format&fit=crop" 
        ...
        <div class="relative z-10 flex flex-col justify-between p-20 w-full h-full">
            ...
            <div class="max-w-xl">
                <h2 class="text-6xl font-black text-white leading-[1.1] tracking-tighter mb-10 font-serif">
                    Atur Ulang <br><span class="italic text-emerald-400">Kata Sandi</span> Anda.
                </h2>
                <p class="text-xl text-emerald-100/80 font-medium leading-relaxed">
                    Jangan khawatir, kami akan membantu Anda mendapatkan akses kembali ke akun Anda dengan aman.
                </p>
            </div>
    ...
    <div class="w-full lg:w-2/5 flex flex-col justify-center items-center p-8 lg:p-20 relative bg-white">
        <div class="w-full max-w-[440px]">
            <a href="{{ route('login') }}" class="inline-flex items-center gap-3 mb-10 px-6 py-3 bg-emerald-50 text-emerald-950 rounded-full text-[12px] font-black uppercase tracking-widest shadow-sm hover:bg-emerald-950 hover:text-white transition-all active:scale-95 group">
            ...
            <div class="mb-12">
                <h1 class="text-4xl font-black text-emerald-950 tracking-tight mb-3">Lupa Password?</h1>
                <p class="text-emerald-950 font-medium opacity-70">Masukkan email Anda untuk menerima link reset password.</p>
            </div>
            ...
            <form action="{{ route('password.email') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="email" name="email" placeholder="contoh@email.com" required class="w-full pl-16 pr-6 py-5 input-premium rounded-[28px] text-[16px] font-bold text-emerald-950">
                    </div>
                </div>
